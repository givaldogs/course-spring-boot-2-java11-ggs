...
/**
 * vai ser responsavel para fazer operacoes com a entidade product
 * Para fazer Product repository reutilizando para estender o JPARepository passando o
 * o tipo da entidade que voce vai acessar e o tipo da chave dessa entidade, no caso
 * a entidade e' Product e o tipo da chave e Long.
 * Os nossos repositories vao ser Interface, porque o JPARepository e' Interface tambem.
 * entao muda class ProductRepository para interface ProductRepository 
